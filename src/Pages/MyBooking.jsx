  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32 '>
        <Title title='My Bookings' subTitle='Easily manage your past , current ,
         and upcoming hotel reservations in one place. 
        ...
        <div className='max-w-6xl mt-8 w-full text-gray-800'>
           ...
           { /* Hotels details */}
            <div className='flex flex-col md:flex-row'>
                <img src={booking.room.images[0]} alt="hotel-img" className='min-md:w-44 rounded 
                shadow object-cover' />
                <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                   ...
                   <div className='flex items-center gap-1 text-sm text-gray-500'>
                     <img src={assets.locationIcon} alt="hotel-location" />
