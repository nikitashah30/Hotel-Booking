  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32 '>
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
            <h1 className='text-3xl md:text-4xl font-playfair'>{room.hotel.name}<span className='font-inter
             text-sm'>
                ({room.roomType})</span></h1>
            <p className='text-xs font-inter py-1.5 px-3 text-white bg-orange-500 rounded-full'>20%
                 OFF</p>
        </div>
        ...
        <div className='flex items-center gap-1 text-gray-500 mt-2'>
            <img src={assets.locationIcon} alt="location" className='flex items-center gap-1
             text-gray-500 mt-2' />
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                {room?.images.length>1 && room.images.map((image ,idx)=>(
                    <img onClick={()=> setMainImage(image)}
                     src={image} alt="room image" key={idx} className={`w-full rounded-xl 
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
            <div className='flex flex-col'>
                <h1 className='text-3xl md:text-4xl font-palyfair'>Experience Luxury Like Never Before</h1>
            ...
            <p className='text-2xl font-playfair'>${room.pricePerNight}/night</p>
        ...
        shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            ...
            md:gap-10 text-gray-500'>
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="date" id='chechInDate' placeholder='Check-In' className='w-full rounded 
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="date" id='chechOutDate' placeholder='Check-Out' className='w-full rounded
                    border border-gray-300 px-3 py-2 mt-1.5 outline-none' required />
                </div>
                <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
                 ...
                 <div className='flex flex-col'>
                    ...
                    <input type="number" id='guests' placeholder='0' className='max-w-20 rounded 
                    border border-gray-300 px-3 py-2 mt-1.5 outline-none' required />
                </div>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>Guests will be allocated on the ground floor according to availability. You get a comfortable 
                Two
                 bedroom apartment has a true city feeling.The price quoted is for two guest, at the 
                 guest slot please mark the number of
                 quests to get the exact price for groups. The Guests will be allocated ground floor
                  according to availability. You 
                 get the comfortable two bedroom apartment that has a true city feeling.</p>
        </div>
        <div className='flex flex-col items-start gap-4'>
            <div className='flex gap-4'>
                <img src={room.hotel.owner.image} alt="host" className='h-14 w-14 md:h-18 
