  ...
  return (
    <div>
        <Title  align='left'  font='outfit' title='Room Listings' subTitle='View, edit, or manage all listed rooms.
         Keep the information up-to-date to provide the best experince for users.' />
                            ...
                            <td className='py-3 px-4 text-gray-700 border-t border-gray-300'>
                             ...
                             <td className='py-3  max-sm:hidden px-4 text-gray-700 border-t border-gray-300'>
                              ...
                              <label  className='relative inline-flex items-center cursor-pointer text-gray-900 gap-3'>
                                      ...
                                      <span className='dot absolute left-1 top-1 h-5 w-5
                                       bg-white rounded-full transition-transform duration-200 ease-in-out peer-checked:translate-x-5'></span>
                              </label>
                            </td>
